            ...
            <div className="row">
               <div className="col-lg-3">
                     ...
                     <div className="card-body py-0">
                        ...
                        <textarea className="form-control mt-3" placeholder="e.g., Tried yoga-felt calmer"></textarea>
                        <div className="d-flex align-items-center w-100 justify-content-between mt-3">
                           ...
                           <button type='button' className="btn btn-svae btn-primary"> Save Log</button>
                        </div>
                     </div>
                     </div>
                     <div className="card">
